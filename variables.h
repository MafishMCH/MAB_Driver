...
#define CHECK 0xA3
/*
### zienne dotyczące bezpośrednio sterownika
*/
uint8_t silnik =0;
uint8_t adress = 0;
uint8_t init = 0;
...
uint32_t is_delay = 1;
/*000000000
 * 			Zmienne związane z obsługą UARTu
 */
uint8_t rxData[10] = {0};
uint8_t txData[10] = {0};
uint8_t rxByte = 0;
...
/*
@brief Zmienne związane z ustawieniami sprężyny
*/
uint16_t poz_zad = 16384;
int32_t ks =850;
int32_t kd = 4;

/*
### zmienne związane ze sterowaniem wektorowym
*/
...
/*
 * 			Zmienne związane z pomiarem prądów
 */
int32_t v3v = 3324;
int32_t iu = 0;
int32_t iuOffset = 0;
