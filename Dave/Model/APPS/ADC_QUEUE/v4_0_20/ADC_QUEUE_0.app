...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="ADC_QUEUE" URI="http://resources/4.0.20/app/ADC_QUEUE/0" description="Provides configurations for queue request source of VADC" version="4.0.20" minDaveVersion="4.0.0" instanceLabel="ADC_QUEUE_0" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="trigger_input" URI="http://resources/4.0.20/app/ADC_QUEUE/0/vs_adc_queue_greqtr0sel" hwSignal="greqtr0sel" hwResource="//@hwResources.0" visible="true">
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../PWM_SVM/v4_0_20/PWM_SVM_0.app#//@connections.37"/>
  </virtualSignals>
  ...
  <virtualSignals name="sr_interrupt_signal" URI="http://resources/4.0.20/app/ADC_QUEUE/0/vs_signal_src" hwSignal="signal_in" hwResource="//@hwResources.2" visible="true"/>
  ...
  <requiredApps URI="http://resources/4.0.20/app/ADC_QUEUE/0/appres_cpu" requiredAppName="CPU_CTRL_XMC4" requiringMode="SHARABLE">
  ...
  <hwResources name="Queue" URI="http://resources/4.0.20/app/ADC_QUEUE/0/hwres_vadc_queue" resourceGroupUri="peripheral/vadc/*/group/*/queue" mResGrpUri="peripheral/vadc/*/group/*/queue">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/VADC/VADC_0.dd#//@provided.131"/>
  </hwResources>
  ...
  <hwResources name="Source Event Interrupt" URI="http://resources/4.0.20/app/ADC_QUEUE/0/hwres_nvicnode_srcevt" resourceGroupUri="peripheral/cpu/0/nvic/interrupt/*" mResGrpUri="peripheral/cpu/0/nvic/interrupt/*">
